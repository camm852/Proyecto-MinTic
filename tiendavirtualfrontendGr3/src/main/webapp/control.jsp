            ...
            <div class="users-form-container">
                <form class="form" action="" method="post">
                    ...
                    <div class="button-container">
                        ...
                        <input class="button-form" type="submit" value="Agregar" onclick="form.action='crearUsuario.jsp';">                     
     					<input class="button-form" type="submit" value="Consultar" onclick="form.action='crearUsuario.jsp';">
     					<input class="button-form" type="submit" value="Actualizar" onclick="form.action='actualizarUsuario.jsp';">                     
     					<input class="button-form" type="submit" value="Eliminar" onclick="form.action='eliminarUsuario.jsp';">
